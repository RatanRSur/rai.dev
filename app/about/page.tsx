  ...
  return (
    <div className="h-full flex flex-row justify-center items-center">
      <div className="full normal-text p-3">
        <p>
          i'm a cofounder @ <a target="_blank" href="https://sentinel-team.org/">sentinel</a>, an org that attempts to foresee large-scale/existential catastrophes and deploy emergency response teams to avert disaster. please <a href="/contact">reach out</a> if you want to learn more, be involved, or support in any way.
        </p>
        <br />
        <br />
        <p>
